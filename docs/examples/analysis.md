...
Scientific data often requires pre-processing before meaningful parameters can be extracted. This demo showcases the **Baseline Subtraction** and **Numerical Integration** tools provided by the `velo-plot-analysis` plugin.
...
For more complex analysis, you can use the **Peak Tool** from the `velo-plot-tools` plugin:
