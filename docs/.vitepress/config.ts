      ...
      "/api/": [
        ...
        },
        {
          ...
          items: [
            ...
            { text: "Waterfall3DRenderer", link: "/api/3d/waterfall-renderer" },
            { text: "VectorField3DRenderer", link: "/api/3d/vector-field-renderer" },
            { text: "PointCloud3DRenderer", link: "/api/3d/point-cloud-renderer" },
            { text: "Voxel3DRenderer", link: "/api/3d/voxel-renderer" },
            { text: "Ribbon3DRenderer", link: "/api/3d/ribbon-renderer" },
            { text: "SurfaceBar3DRenderer", link: "/api/3d/surface-bar-renderer" },
      ...
      "/examples/": [
        ...
        },
        {
          ...
          items: [
            ...
            { text: "Vector Field (Quiver)", link: "/examples/3d/vector-field" },
            { text: "High-Density Point Cloud", link: "/examples/3d/point-cloud" },
            { text: "Voxel (Volumetric)", link: "/examples/3d/voxel-chart" },
            { text: "Ribbon Chart", link: "/examples/3d/ribbon-chart" },
            { text: "3D Histogram (Columns)", link: "/examples/3d/column-chart" },
